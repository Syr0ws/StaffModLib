...
public class NewStaffModListener extends BukkitStaffModListener {

    public NewStaffModListener(StaffModManager<Player, ItemStack> manager) {
        super(manager);
    }
    ...
    public void onPlayerInteract(PlayerInteractEvent event) {
        ...
        // Event can be called twice without this.
